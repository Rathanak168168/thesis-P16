...
import national from "../Components/Image/nationalpark.jpg";
import kepButterfly from "../Components/Image/KepButterfly.jpg";
import KohTonsay from "../Components/Image/KohTonsay.jpg";
import CrabStatue from "../Components/Image/CrabStatue.jpg";
import popokvil from "../Components/Image/PopokvilWaterfalljpg.jpg";

import { useNavigate } from "react-router-dom";
function kompot() {
  const navigate = useNavigate();
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const images = [national, kepButterfly, KohTonsay, CrabStatue, popokvil];
  const tourName = "Kep&Kompot";
        ...
        <div className="text-container">
          ...
          <div className="itinerary">
            ...
            <div className="day-block">
              <strong>Place 1:</strong> <span>Kep National Park</span>
            </div>
            <div className="day-block">
              <strong>Place 2:</strong> <span>kepButterfly</span>
            </div>
            <div className="day-block">
              <strong>Place 3:</strong> <span>KohTonsay</span>
            </div>
            <div className="day-block">
              <strong>Place 4:</strong> <span>CrabStatue</span>
            </div>
            <div className="day-block">
              <strong>Place 5:</strong> <span>Prasat Kuhak Nokor</span>
            </div>
          </div>
        </div>
      </div>
