...
import Fishing from "../Components/Image/fishing.jpg";
import High from "../Components/Image/high.jpg";
import Paddleboarding from "../Components/Image/paddleboarding.jpg";
import Blob from "../Components/Image/blob.jpg";
import Light from "../Components/Image/lighthome.jpg";

import { useNavigate } from "react-router-dom";
function Kohrong() {
  const navigate = useNavigate();
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const images = [Fishing, High, Paddleboarding, Blob, Light];
  const tourName = "Koh Rong Tour";
        ...
        <div className="text-container">
          ...
          <div className="itinerary">
            ...
            <div className="day-block">
              <strong>Place 1:</strong> <span>Diving</span>
            </div>
            <div className="day-block">
              <strong>Place 2:</strong> <span>High Point </span>
            </div>
            <div className="day-block">
              <strong>Place 3:</strong> <span>Paddleboarding</span>
            </div>
            <div className="day-block">
              <strong>Place 4:</strong> <span>Koh Rong blob jump</span>
            </div>
            <div className="day-block">
              <strong>Place 5:</strong> <span>Lighthouse</span>
            </div>
          </div>
        </div>
      </div>
